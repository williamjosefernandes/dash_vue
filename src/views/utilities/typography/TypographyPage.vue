      ...
      <v-row>
        <v-col cols="12">
          <UiParentCard title="Alignment">
            <p class="text-left text-caption mb-3">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
        ...
        <v-col cols="12">
          <UiParentCard title="Colors">
            <h6 class="text-h6 text-primary mb-2">This is Primary text color.</h6>
            <h6 class="text-h6 text-secondary mb-2">This is Secondary text color.</h6>
            <h6 class="text-h6 text-success mb-2">This is Success text color.</h6>
            <h6 class="text-h6 text-warning mb-2">This is Warning text color.</h6>
